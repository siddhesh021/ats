...
export default function SignUp() {
  ...
  const {name,email,password,college,academicyear,stream,uid,contactno,gender,nationality,category,empstatus} = formdata;
  function change(e){
  ...
  async function onSubmit(e) {
    ...
    try {
      const auth = getAuth();
      const userCredentials = await createUserWithEmailAndPassword(auth, email, password,college,academicyear,stream,uid,contactno,gender,nationality,category,empstatus)
